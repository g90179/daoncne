              ...
              <div className="xl:col-span-5">
                {editingUser ? (
                  <div className="bg-white p-8 rounded-[2rem] shadow-xl border border-blue-100 space-y-4 animate-fadeIn">
                    ...
                    <input type="text" className="w-full px-5 py-3 bg-gray-50 border rounded-2xl outline-none" value={editPhone} onChange={e => setEditPhone(e.target.value)} />
                  ...
                  <div className="bg-white p-8 rounded-[2rem] shadow-xl border space-y-4">
                    ...
                    <input type="text" placeholder="연락처" className="w-full px-5 py-3 bg-gray-50 border rounded-2xl outline-none" value={newUserPhone} onChange={e => setNewUserPhone(e.target.value)} />
                    ...
                    {users.map(u => (
                      <div key={u.id} className="p-6 flex justify-between items-center hover:bg-slate-50">
                        <div>
                          ...
                          <p className="text-xs text-slate-400 mt-0.5">{u.phone || '연락처 없음'} — <span className="text-orange-500 font-bold">{u.role}</span></p>
                        </div>
          ...
          <div className="max-w-4xl mx-auto space-y-12 animate-fadeIn">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <input type="text" placeholder="사업자 번호" className="w-full px-5 py-3 bg-gray-50 border rounded-2xl outline-none" value={bizNumber} onChange={e => setBizNumber(e.target.value)} />
                <input type="text" placeholder="대표 전화" className="w-full px-5 py-3 bg-gray-50 border rounded-2xl outline-none" value={phone} onChange={e => setPhone(e.target.value)} />
